export default {
  ...
  "mode.agent": "Agent",
  "mode.plan": "Plan",
  "mode.chatHint": "Conversación de preguntas y respuestas",
  "mode.agentHint": "Tareas autónomas en varios pasos con herramientas",
  "mode.planHint": "Plan estructurado antes de ejecutar",
  planSuggest: "Parece una tarea compleja. ¿Cambiar al modo Plan?",
  planSwitch: "Usar modo Plan",
  planDismiss: "Descartar",
  workspaceToggle: "Archivos del espacio de trabajo",
  workspaceTitle: "Espacio de trabajo",
  workspaceAddFiles: "Añadir archivos al chat",
  workspaceAddToChat: "Insertar archivo en la entrada",
  workspaceSave: "Guardar archivo",
  workspaceTruncated: "(vista previa truncada)",
  contextMenu: {
    addSelection: "Añadir selección al chat",
    selectAll: "Seleccionar todo el mensaje",
    copyChatText: "Copiar todo el chat (texto)",
    copyChatMarkdown: "Copiar todo el chat (Markdown)",
  },
  workspaceMenu: {
    addFile: "Añadir archivo al chat",
    addFolder: "Añadir carpeta al chat",
    addSelection: "Añadir selección al chat",
    openFile: "Abrir en el editor",
  },
  planApproveHint:
    "El plan está listo. Aprueba para ejecutar en modo Agent.",
  planApproveAndRun: "Aprobar e iniciar Agent",
  planApproveMessage:
    "Apruebo el plan anterior. Ejecútalo paso a paso con las herramientas disponibles e informa del progreso.",
