export default {
  ...
  nousDesc: "API key or OAuth — optional at setup",
  nousTag: "Optional",
  copilotSetupName: "GitHub Copilot",
  oauthTag: "Sign in",
  localName: "Local",
  ...
  groq: "Groq",
  deepseek: "DeepSeek",
  deepseekSetupDesc: "Chat & coder models (works well in China)",
  deepseekTag: "Recommended",
  kimiMoonshot: "Kimi Open Platform",
  kimiMoonshotCn: "Kimi China (moonshot.cn)",
  kimiCode: "Kimi Code",
  opencodeGo: "OpenCode Go",
  opencodeZen: "OpenCode Zen",
  qwenDashscope: "Qwen DashScope",
  kimiCodingApiKey: "Kimi Code API Key",
  kimiCodingHint:
    "Coding plan only — use https://api.kimi.com/coding/v1; not interchangeable with Moonshot keys",
  ...
  kimiHint:
    "Open Platform — https://api.moonshot.ai/v1 or China https://api.moonshot.cn/v1; separate from Kimi Code",
