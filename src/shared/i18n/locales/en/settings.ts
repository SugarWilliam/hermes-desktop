export default {
  ...
  colorTheme: {
    label: "Color theme",
    hint: "Accent and background style on top of light/dark. Default is the built-in look",
    default: "Default",
    midnight: "Midnight",
    ocean: "Ocean",
    warm: "Warm",
  ...
  fontScale: {
    label: "Font size",
    hint: "Base text size for the UI and chat",
    sm: "Small",
    md: "Default",
    lg: "Large",
    xl: "Extra large",
  ...
  uiFont: {
    label: "UI font",
    hint: "Sidebar, buttons, inputs, and labels",
    googleSans: "Google Sans (default)",
    system: "System sans",
    serif: "Serif",
    mono: "Monospace",
  },
  agentFont: {
    label: "Agent font",
    hint: "Agent replies, thinking blocks, and markdown reports",
    courier: "Courier New (default)",
    consolas: "Consolas",
    systemMono: "System mono",
    googleSans: "Google Sans",
  },
  appearanceReset: "Reset appearance",
  appearanceResetHint: "Restore light/dark, color theme, size, and fonts to defaults",
  language: {
    label: "Language",
    english: "English",
  ...
  usage: {
    ...
    period30d: "30 Days",
    period90d: "90 Days",
    empty: "No usage data yet. Start chatting to see your token consumption and costs.",
  ...
  logs: {
    startWatch: "Start live tail",
    stopWatch: "Stop live tail",
    pause: "Pause",
    resume: "Resume",
  ...
  keybindings: {
    ...
    desc: "Click a shortcut to record a new key combination. Press Esc to cancel.",
