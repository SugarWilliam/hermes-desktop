export default {
  ...
  nousDesc: "API Key 或 OAuth 登录，均可直接使用",
  nousTag: "可选",
  ...
  groq: "Groq",
  deepseek: "DeepSeek",
  deepseekSetupDesc: "国内可用，对话与编码模型",
  deepseekTag: "国内推荐",
  kimiMoonshot: "Kimi 开放平台",
  kimiMoonshotCn: "Kimi 国内 (moonshot.cn)",
  kimiCode: "Kimi Code 编程",
  opencodeGo: "OpenCode Go",
  opencodeZen: "OpenCode Zen",
  qwenDashscope: "通义 DashScope",
  kimiCodingApiKey: "Kimi Code API Key",
  kimiCodingHint:
    "编程套餐专用 — Base URL 须为 https://api.kimi.com/coding/v1，与开放平台 Key 不可混用",
  ...
  kimiHint:
    "开放平台 — 使用 https://api.moonshot.ai/v1 或国内 https://api.moonshot.cn/v1，勿与 Kimi Code Key 混用",
